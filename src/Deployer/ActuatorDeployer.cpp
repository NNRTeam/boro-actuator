...
void ActuatorDeployer::_deployServos()
{
    ...
    m_srv_bottom_1.attach(config::SERVO_BANER_LEFT_PIN);
    m_srv_bottom_2.attach(config::SERVO_BANER_RIGHT_PIN);
    ...
    m_srv_bottom_1.write(config::SERVO_BANER_LEFT_HOME_ANGLE);
    m_srv_bottom_2.write(config::SERVO_BANER_RIGHT_HOME_ANGLE);
